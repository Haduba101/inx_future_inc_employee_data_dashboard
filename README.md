...
- `inx_data.csv`: Main employee dataset containing various attributes like age, department, job role, salary, etc.
- `data_definitions.csv`: Definitions for categorical variables (e.g., education levels, satisfaction ratings)
- `inx_data.ipynb`: Jupyter notebook with data analysis and preprocessing
